...
pares = [
    ...
    [ 
        r"((oi|olá|ola|bom dia|boa tarde|boa noite|ta bom|tudo bem|ok|vamos em frente|ok beleza|ok, beleza|pode ser)|(oi|olá|ola|bom dia|boa tarde|boa noite|ta bom|tudo bem|ok|vamos em frente|ok beleza|ok, beleza|pode ser)(.*))", 
        ["FomeBot:Você sabe que tipo de restaurante está procurando?"]
    ],

	[ 
        r"((caro|achei caro|é caro|não gostei do preço|preço salgado|nossa que caro|achei muito caro)|(.*) (caro))", 
    ...
    [ 
        r"(sim|sim, obrigada|sim, obrigado|sim obrigada|sim obrigado|pode ser|pode)|(.*)(sim)", 
        ["FomeBot: Que tipo de restaurante você procura?"]
    ],

    [ 
        r"não|nao|não, obrigada|não, obrigado|não obrigada|não obrigado|nao obrigado|nao obrigada|não obrigado|não obrigada", 
        ["FomeBot: Hmm... \n\n Que tipo de comida você está com vontade de comer?"]
    ],
	[ 
        r"(obrigada|obrigado|valeu)|(.*)(obrigada|obrigado|valeu)", 
        ["FomeBot: Por nada, estou à disposição \n\n "]
    ],
